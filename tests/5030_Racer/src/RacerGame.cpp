...
void RacerGame::initialize()
{
    ...
    _backgroundMusic = AudioSource::create("res/common/sample.audio#backgroundTrack");
    _backgroundMusic->play();
    _backgroundMusic->setGain(0.3f);

    _engineSound = AudioSource::create("res/common/sample.audio#engine");
    if (_engineSound)
    {
    ...
    _brakingSound = AudioSource::create("res/common/sample.audio#braking");
